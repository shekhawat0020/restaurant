        ...
        <!-- COL END -->
							<div class="col-lg-6">
								<div class="card">
									...
									<div class="card-body">
                                    <form id="submitForm"  method="post" action="{{route('table-save')}}">
                                    {{csrf_field()}}
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        successMsg('Create Table', 'Table Created...');
                        $('#submitForm')[0].reset();
                ...
                error: function() {
                    errorMsg('Create Table', 'There has been an error, please alert us immediately');
                    buttonLoading('reset', $this);
                }
