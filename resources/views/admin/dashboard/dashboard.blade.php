                        ...
                        <div class="table-responsive ">
                            <table class="users table card-table border table-striped table-vcenter text-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>2345</td>
                                        <td><img src="{{ asset('admin/assets/images/users/3.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32"></td>
                                        <td>Megan Peters</td>
                                    ...
                                    <tr>
                                        <td>4562</td>
                                        <td><img src="{{ asset('admin/assets/images/users/12.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32"></td>
                                        <td>Phil Vance</td>
                                        <td>New stock</td>
                                    ...
                                    <tr>
                                        <td>8765</td>
                                        <td><img src="{{ asset('admin/assets/images/users/15.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32"></td>
                                        <td>Adam Sharp</td>
                                        <td>Daily updates</td>
                                    ...
                                    <tr>
                                        <td>2665</td>
                                        <td><img src="{{ asset('admin/assets/images/users/5.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32"></td>
                                    ...
                                    <tr>
                                        <td>2665</td>
                                        <td><img src="{{ asset('admin/assets/images/users/11.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32"></td>
                                        <td>Samantha Slater</td>
                                        <td>available item list</td>
                                        <td class="text-nowrap">June 28, 2019</td>
                                        <td><button type="button" class="btn btn-icon  btn-danger"><i class="fa fa-trash-o"></i></button></td>
